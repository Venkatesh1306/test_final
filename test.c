...
unsigned char ModbusTcpRxBuftest[INR_SIZE][100] = {
    ...
    {0x0c, 0x00, 0x01, 0x00, 0x02, 0x00, 0x06, 0x03, 0x01, 0x00, 0x01, 0x00, 0x08},
...
unsigned char Test_TXtest[INR_SIZE][100] = {
    ...
    {0x0b, 0x00, 0x01, 0x00, 0x02, 0x00, 0x05, 0x03, 0x01, 0x02, 0xff},                        // F-01
    ...
    {0x0D, 0x00, 0x01, 0x00, 0x02, 0x00, 0x07, 0x03, 0x04, 0x4, 0x3a, 0x2b, 0x3c, 0x7e},             // F-04
...
int main()
{
   ...
   for (incrs = 0; incrs < INR_SIZE; incrs++)
   {
      ...
      frame_function(&ModbusTcpRxBuf[0], &Dataregister[0], &InputRegister[0], &COIL[0], &parse, &ModbusTcpTxBuf[0], &ModbusTxLength); // main call function
